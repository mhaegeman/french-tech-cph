...
export default async function StartupsPage({
  ...
  return (
    <PageShell
      eyebrow={t("community")}
      title={t("startups")}
      intro="French startups operating in Denmark, or Danish startups with strong French ties. Sourced from Airtable — submit yours via the form."
    >
